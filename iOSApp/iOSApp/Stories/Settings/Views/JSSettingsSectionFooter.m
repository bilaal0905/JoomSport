...
CGFloat const JSSettingsSectionFooterHeight = 39.0;

@implementation JSSettingsSectionFooter {
    UILabel *_label;
}
...
- (instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _label = ({
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-8-[label]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)]];
